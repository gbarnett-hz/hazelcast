...
public final class ElasticSupport {
    ...
    public static final String TEST_ELASTIC_VERSION = System.getProperty("test.elastic.version", "9.2.4");
    ...
    public static SupplierEx<RestClientBuilder> secureElasticClientSupplier() {
        ElasticsearchContainer container = secureElastic.get();
        String containerHost = container.getHost();
        Integer port = container.getMappedPort(PORT);

        return () -> client("elastic", "SuperSecret", containerHost, port, "http");
    }
