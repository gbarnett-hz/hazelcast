...
public class CPMapProxy<K, V> implements CPMap<K, V> {
    ...
    public CPMapProxy(String name) {
        this.name = name;
    }

    @Override
    public String getPartitionKey() { // DistributedObject
        throw new UnsupportedOperationException();
    }

    @Override
    public String getName() { // DistributedObject
        return name;
    }

    @Override
    public String getServiceName() { // DistributedObject
        return CPMapService.SERVICE_NAME;
    }

    @Override
    public void destroy() { // DistributedObject
        throw new UnsupportedOperationException();
    }
