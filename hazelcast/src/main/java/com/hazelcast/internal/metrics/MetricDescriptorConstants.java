...
public final class MetricDescriptorConstants {
    ...
    public static final String OPERATION_METRIC_INVOCATION_REGISTRY_INVOCATIONS_PENDING_LOCAL = "pendingLocal";
    public static final String OPERATION_METRIC_INVOCATION_REGISTRY_INVOCATIONS_PENDING_REMOTE = "pendingRemote";
